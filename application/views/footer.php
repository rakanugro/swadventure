						...
						<div class="row">
							...
							<div class="col-md-3 col-sm-6">
								<div class="widget widget-customer-info">
									...
									<img src="<?php base_url() ?>assets/outbound/dummy/footer-customer-service.jpg" alt="" class="pull-left">
									<div class="cs-info">
				...
				<div class="footer-bottom">
					<div class="container">
						<div class="branding pull-left">
							<img src="<?php base_url() ?>assets/outbound/images/logo-footer.png" alt="Company Name" class="logo">
							<h1 class="site-title"><a href="index.html">Outbound & Adventure</a></h1>
							<small class="site-description">“Travel is the only thing you buy that makes you richer.”</small>
						</div>
